...
export const MCPAddServer: React.FC<MCPAddServerProps> = ({
    ...
    return (
      <div className="space-y-3">
        <div className="flex items-center justify-between">
          <Label className="text-sm font-medium">{t('mcp.envVars')}</Label>
          <Button
            variant="outline"
            size="sm"
  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        <h3 className="text-base font-semibold">{t('mcp.addTitle')}</h3>
        ...
        <TabsContent value="stdio" className="space-y-6">
          <Card className="p-6 space-y-6">
            <div className="space-y-4">
              ...
              <div className="space-y-2">
                <Label htmlFor="stdio-args">{t('mcp.argsOptional')}</Label>
                <Input
                  id="stdio-args"
