...
export const CCAgents: React.FC<CCAgentsProps> = ({ onBack, className }) => {
  ...
  const confirmDeleteAgent = async () => {
    ...
    try {
      ...
      setToast({ message: t('agents.deleted'), type: "success" });
      await loadAgents();
  ...
  const handleAgentCreated = async () => {
    setView("list");
    await loadAgents();
    setToast({ message: t('agents.createdOk'), type: "success" });
  };

  const handleAgentUpdated = async () => {
    setView("list");
    await loadAgents();
    setToast({ message: t('agents.updatedOk'), type: "success" });
  };
  ...
  const handleImportAgent = async () => {
    try {
      ...
      setToast({ message: t('agents.importedOk'), type: "success" });
      await loadAgents();
    } catch (err) {
    ...
    <div className={cn("flex flex-col h-full bg-background", className)}>
        ...
        >
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-heading-1">{t('agents.titleCC')}</h1>
              ...
              <div>
                {loading ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-64 text-center">
                    ...
                    <h3 className="text-heading-4 mb-2">{t('agents.emptyTitle')}</h3>
              ...
              {!loading && agents.length > 0 && (
                <div className="overflow-hidden">
                  <div className="flex items-center gap-2 mb-4">
                    ...
                    <h2 className="text-heading-4">{t('agents.recentRuns')}</h2>
                  </div>
                  {runsLoading ? (
      ...
      <GitHubAgentBrowser
        ...
        onImportSuccess={async () => {
          ...
          await loadAgents();
          setToast({ message: t('agents.importedGitHub'), type: "success" });
        }}
      />
